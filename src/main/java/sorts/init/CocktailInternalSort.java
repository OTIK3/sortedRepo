...
public class CocktailInternalSort extends InternalSort {
    ...
    public CocktailInternalSort(List<Integer> array) {
        super(array);
    }

    public CocktailInternalSort(int size, int bound){
        super(size, bound);
    }

    public CocktailInternalSort(int size, int bound, boolean isUnique) {
